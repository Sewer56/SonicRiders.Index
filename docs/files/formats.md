...
| .XVRS | PVR Texture Library | [Sega NN Tools or RidersTextureArchiveTool](https://github.com/Sewer56/SonicRiders.Index/tree/master/Source/RidersTextureArchiveTool) | [XvrsTextureArchive.bt](https://github.com/Sewer56/SonicRiders.Index/blob/master/docs/files/template/XvrsTextureArchive.bt) | v.XVRs | For some strange reason they decided to use a file extension which made it look like it belongs to Sega NN library. |
