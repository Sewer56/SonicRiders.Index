...
## Internal File Formats: Reference

Native `Riders Archives` will contain a list of individual groups of files (sub-archives), whose format is decided by a unique id. These groups consist of individual files.

For example, inside every stage archive you can find group `305`, which contains the following files:
