...
| ----------- | ------ | ------------ | ------------- | ------------ | ----------- |
| .DAT | XBOX DTPK |  | [AM2-DTPK.txt](https://github.com/Shenmue-Mods/DTPKUtil/blob/master/AM2-DTPK.txt) | 00.dat | Archive containing uncompressed audio. Variant of .SND used in Shenmue, alongside other games. Most likely PCM 16-bit, 1 Channel, 22050Hz audio; but there can sometimes be a mix of multiple frequencies. DTPKUtil may support the Xbox variant we use in the future. |
| N/A | Riders Archive | [RidersArchiveTool](https://github.com/Sewer56/SonicRiders.Index/tree/master/Source/RidersArchiveTool) | [PackMan.bt](https://github.com/Sewer56/SonicRiders.Index/blob/master/docs/formats/template/PackMan.bt) | 1 | Sonic Riders' native archive format. Has optional compression and no extension. |
| .ADX | CRI ADX | [radx](https://github.com/Isaac-Lozano/radx) | [Wikipedia](https://en.wikipedia.org/wiki/ADX_(file_format)) | E01E.ADX | Lossy proprietary audio format from CRI Middleware for low CPU audio playback. |
| .AIX | CRI AIX | [aixmaker (CRI SDK)](http://shenmuesubs.sourceforge.net/download/addons/CRI_Middleware_ADX_Tools_v1.15_Linux_Win32.rar) |  | ED_E.AIX | Proprietary audio format from CRI Middleware storing multiple ADX tracks in one file. |
| .SFD | CRI SofDec | [SofDec CRAFT (CRI SDK) or SfdMux](https://archive.org/details/CRISDK113XB) |  | ENDING.sfd | Proprietary video format from CRI Middleware which is a wrapper for MPEG-1 (Riders) or MPEG-2 video, with ADX-encoded audio. |
| .XNF | Sega NN: Morph Animation |  | [](https://gist.github.com/Radfordhound/5650ef12209da2709a6bf9b705bdd79c) | v.xnf |  |
| .XNG | Sega NN: ?? Animation |  | [](https://gist.github.com/Radfordhound/5650ef12209da2709a6bf9b705bdd79c) | v.xng |  |
| .XNM | Sega NN: Skeletal Animation |  | [](https://gist.github.com/Radfordhound/5650ef12209da2709a6bf9b705bdd79c) | v.xnm |  |
| .XNO | Sega NN: 3D Object | [Sega NN Tools](https://github.com/Argx2121/Sega_NN_tools) | [](https://gist.github.com/Radfordhound/5650ef12209da2709a6bf9b705bdd79c) | v.xno |  |
| .XNV | Sega NN: Material Animation |  | [](https://gist.github.com/Radfordhound/5650ef12209da2709a6bf9b705bdd79c) | v.xnv |  |
| .XVRS | PVR Texture Library | [Sega NN Tools or RidersTextureArchiveTool](https://github.com/Sewer56/SonicRiders.Index/tree/master/Source/RidersTextureArchiveTool) | [XvrsTextureArchive.bt](https://github.com/Sewer56/SonicRiders.Index/blob/master/docs/formats/template/XvrsTextureArchive.bt) | v.XVRs | For some strange reason they decided to use a file extension which made it look like it belongs to Sega NN library. |
| .AFS | CRI AFS | [AFSUtils](https://sourceforge.net/projects/shenmuesubs/files/AFS%20Utils/afsutils_23.7z/download) | [GRAF:AFS](http://wiki.xentax.com/index.php/GRAF:AFS_AFS) | Voice\VOICE.AFS | Proprietary archive from CRI Middleware which contains a collection of audio files in either ADX, AIX or AHX format (interchangeable). |
...
| ----------- | ------------ | ------------- | ------------ | ----------- |
| Object Layout Format | [Riders.Tweakbox](https://github.com/Sewer56/Riders.Tweakbox) | [ObjectLayout.bt](https://github.com/Sewer56/SonicRiders.Index/blob/master/docs/formats/template/ObjectLayout.bt) | 1 -> 00305 -> 00000 | Defines the layout of objects in Sonic Riders |
| Object Visibility Layout Format | []() | [ObjectVisibility.bt](https://github.com/Sewer56/SonicRiders.Index/blob/master/docs/formats/template/ObjectVisibility.bt) | 1 -> 00301 -> 00000 | Defines object rendering regions. It contains a list of 3D bounding boxes objects indexed an ASCII character. If an object has the same character assigned but is not in the box, it is not loaded. |
