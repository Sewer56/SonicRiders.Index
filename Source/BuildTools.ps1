...
dotnet publish ./LayoutToJsonTool/LayoutToJson/LayoutToJson.sln -c Release -r win-x64 /p:PublishSingleFile=true /p:PublishReadyToRun=true --self-contained=false -o ./Build
dotnet publish ./GcaxDatInjector/GcaxDatInjector.sln -c Release -r win-x64 /p:PublishSingleFile=true /p:PublishReadyToRun=true --self-contained=false -o ./Build
