...
| Extension   | Format      | Tool        | Specification | Example File | Description |
| ----------- | ----------- | ----------- | ------------- | ------------ | ----------- |
| .DAT | XBOX DTPK | [DTPKUtil (maybe in the future)](https://github.com/Shenmue-Mods/DTPKUtil) | [AM2-DTPK.txt](https://github.com/Shenmue-Mods/DTPKUtil/blob/master/AM2-DTPK.txt) | 00.dat | Archive containing uncompressed audio. Variant of .SND used in Shenmue, alongside other games. Most likely PCM 16-bit, 1 Channel, 22050Hz audio; but there can sometimes be a mix of multiple frequencies. |
...
| .SFD | CRI SofDec | [SofDec CRAFT (CRI SDK) or SfdMux](https://archive.org/details/CRISDK113XB) |  | ENDING.sfd | Proprietary video format from CRI Middleware which is a wrapper for MPEG-1 or MPEG-2 video, with ADX-encoded audio. |
| .XNF | Sega NN: Morph Animation |  |  | v.xnf |  |
| .XNG | Sega NN: ?? Animation |  |  | v.xng |  |
| .XNM | Sega NN: Skeletal Animation |  |  | v.xnm |  |
| .XNO | Sega NN: 3D Object | [Sega NN Tools](https://github.com/Argx2121/Sega_NN_tools) |  | v.xno |  |
| .XNV | Sega NN: Material Animation |  |  | v.xnv |  |
| .XVRS | PVR Texture Library | [Sega NN Tools](https://github.com/Argx2121/Sega_NN_tools) |  | v.XVRs | For some strange reason they decided to use a file extension which made it look like it belongs to Sega NN library. |
...
| Format      | Tool        | Specification | Example File | Description |
| ----------- | ----------- | ------------- | ------------ | ----------- |
